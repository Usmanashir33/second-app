...
const CommentForm = ({data,setData}) => {
    ...
    const  {comment:postComments,fetchComment} = useContext(dataRendingContext);
    const newComment = {body:textarea};
    const url = commentFormType == 'post'? `/posts/post/${clickedObjectId}/comments/` : `commenturl`
    const {doPost:sendData} =  usePostData(url);
                 ...
                 <div className="form-header">
                     ...
                     <div className="post-card borderless post-in-form">
                         ...
                         <div className="post-col2">
                             ...
                             required value={textarea} onChange={(e) => {setTextArea(e.target.value)}} placeholder="Post your reply"></textarea>
                         </div>
                     </div>
