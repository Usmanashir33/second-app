        ...
        <div className="profile main-page ">
            ...
            <div className="user-info">
                ...
                <div className="follow">
                    <Link to={`/followings/${p}`} > <span className="following " > {user && user.followings.length} </span> followings </Link>
                    <Link to={`/followers/${p}`} > <span className="followers ml-10">{user && user.followers.length}</span> followers </Link>
                </div>
            </div>
