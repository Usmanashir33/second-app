...
const Sidebar = () => {
    const {setShowLogOut,showLogOut,currentUser,logOut} = useContext(authContext);
    useEffect(() => {
    },[])
    return ( 
        <div className="sidebar hidde">
                ...
                <div className="side-element"onClick={(e) => {e.stopPropagation(setShowLogOut(!showLogOut)}}>
