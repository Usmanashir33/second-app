...
const UpdateForm = ({data,setData}) => {
    ...
    const url = commentFormType == 'post'? `/posts/post/${clickedObjectId}/` : `/posts/comment/${clickedObjectId}/comment/`
    ...
    useEffect(() => {
        // setTextArea(''); //to avoid clash in data 
                 ...
                 <div className="form-header">
                     ...
                     <div className="post-card borderless post-in-form">
                         ...
                         <div className="post-col2">
                             ...
                             <div className="post-col2">
                                {(body && !textarea) && setTextArea(body)}
                               {body && 
