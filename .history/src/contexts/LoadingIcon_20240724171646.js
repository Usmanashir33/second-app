    ...
    return ( 
        <div className="loading-main">
            <div className="tri-content dropdown hidde">
                <a href="##" className="add-account c child-link">Add another account</a>
                <a href="##" className="log-out c child-link">logout from  <span className="current-account">Coiner mk</span></a>
