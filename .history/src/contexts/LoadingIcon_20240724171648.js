    ...
    return ( 
        <div className="loading-main">
            <div className="tri-content dropdown hidde">
                <a href="##" className="add-account clean child-link">Add another account</a>
                <a href="##" className="log-out clean child-link">logout from  <span className="current-account">Coiner mk</span></a>
