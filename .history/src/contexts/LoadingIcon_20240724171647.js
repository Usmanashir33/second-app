    ...
    return ( 
        <div className="loading-main">
            <div className="tri-content dropdown hidde">
                <a href="##" className="add-account clea child-link">Add another account</a>
                <a href="##" className="log-out clea child-link">logout from  <span className="current-account">Coiner mk</span></a>
