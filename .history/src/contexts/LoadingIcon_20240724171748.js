    ...
    return ( 
        <div className="loading-main">
            <div className="tri-content dropdown hidde">
                <div href="##" className="add-account child-link">Add another account</div>
                <div href="##" className="log-out child-link">logout from  <span className="current-account">Coiner mk</span></div>
