...
const CommentForm = ({type}) => {
    ...
    const parent = (type === "comment")? post : comment;
                         ...
                         <div className="post-col2">
                             <div className="post-header">
                                 <div className="user-data">
                                    <span className="post-name in-form-name">{parent && parent.user.first_name} {parent && parent.user.first_name}</span>
                             ...
                             <div className="replying-to">
                                 <span className="small-txt muted-txt">Replaying to </span><span className="in-form-username-link">
                                     <Link to={`profile/${parent && parent.user.id}`} className="simple-link small-txt">{parent && parent.username} </Link>
                                 </span>
                             </div>
                         </div>
                     </div>
