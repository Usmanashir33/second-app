import { faArrowUp, faArrowUp91, faArrowUpAZ, faEye, faMessage, faRotateBackward } from "@fortawesome/free-solid-svg-icons";
...
const PostCard = ({object,postLink,ishover,commentClick}) => {
    const {fullname,pic,username,post,postPic,likes,reposts,
        comments,views,share,id,date} = object;
