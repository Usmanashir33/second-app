...
const UserPosts = () => {
    ...
    const {showCForm, {showCForm &&
        <CommentForm  data={comments} setData={setComments}/>
    }
    {showUForm && <UpdateForm  data={comments} setData={setComments}/> },posts:data,setPosts,fetchPosts,setUserTotal} = useContext(dataRendingContext);
    useEffect(() => {
