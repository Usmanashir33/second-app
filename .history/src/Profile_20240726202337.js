...
import { faArrowRotateBack, faLocationDot} from "@fortawesome/free-solid-svg-icons";
...
const Profile = () => {
    ...
    // console.log(pk);
    const {error,user} = useGetUser(pk);
    ...
    //     page start
        <div className="profile main-page ">
            ...
            <header className="fixed-header flex profile-header">
                <Link to='/'>
                    <div className="mr-back">
                        <FontAwesomeIcon icon={faArrowRotate}/>
                    </div>
                </Link>
                <div className="names">
