    ...
    return ( 
        <div className="sidebar hidde">
                ...
                <div className="side-element" >
                    <a href="/"><img src={process.env.PUBLIC_URL + '/image/perfect_logo.png'className='side-i'} alt="logo"id='logo' srcSet=""/></a>
                </div>

                <div className="side-element" >
                    <a href="/"><i className="fa-solid fa-house side-icon "></i></a>
                </div>
                ...
                <div className="side-element" >
                    <a href="/"><i className="fa-solid fa-envelope side-icon"></i></a>
                </div>
