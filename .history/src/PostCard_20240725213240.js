import { faMessage, faRotateBackward } from "@fortawesome/free-solid-svg-icons";
                ...
                <div className="post-col2">
                    ...
                    <div className="postnav">
                                ...
                                <Link to="##" className='post-nav-link child-link' id ="repost-${id}">
                                    <div className="" >
                                    <FontAwesomeIcon icon={faRotateBackward} className="comment" />{comments}{reposts}
                                    </div>
                                </Link>
                                ...
                                <Link to="##" className='post-nav-link child-link' id ="share-${id}">
                                    <div className="share" >
                                        <i className="fa-solid fa-arrow-up-from-bracket"></i> 20
                                    </div>
                                </Link>
                    </div>
                </div>
