...
const PostCard = ({object,doDelete,ishover,cardType}) => {
    ...
    const { setCommentFormType,setShowCForm,setShowUForm,setClickedObjectId,getDate} = useContext(dataRendingContext)
                ...
                <div className="post-col2">
                    <div className="post-header">
                                <div className="post-userdata">
                                    ...
                                    <span className="post-date">{getDate(date)}</span>
                                </div>
                    ...
                    <div className="postnav">
                                ...
                                <div className='post-nav-link child-link' >
                                    <div className="like" >
                                    <FontAwesomeIcon icon={faHeart} className={`comment ${liked}`} id ={`${cardType}like-${id}`}
