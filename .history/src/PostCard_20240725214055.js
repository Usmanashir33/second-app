import { faArrowUp91, faArrowUpAZ, faEye, faMessage, faRotateBackward } from "@fortawesome/free-solid-svg-icons";
                ...
                <div className="post-col2">
                    ...
                    <div className="postnav">
                                ...
                                <Link to="##" className='post-nav-link child-link' id ="share-${id}">
                                    <div className="share" >
                                        <FontAwesomeIcon icon={faArrowUp91} className="comment" />{comments}
                                    </div>
                                </Link>
                    </div>
                </div>
