        ...
        <div className="profile main-page ">
            ...
            <div className="user-buttons">
               ...
               {(!myProfile && !followed) && <Link to ="#" className="simple-link"  >
                    <button type="button" onClick={(e) => {followUser(`/accou`)}} className="user-btn">follow</button>
                </Link>}
               {(!myProfile && followed) && <Link to ="#" className="simple-link"  >
                    <button type="button" onClick={(e) => {followUser(`/accou`)}} className="followed">unfollow</button>
                </Link>}
