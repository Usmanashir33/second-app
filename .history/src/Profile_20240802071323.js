        ...
        <div className="profile main-page ">
            ...
            <div className="user-info">
                ...
                <div className="follow">
                    <Link to={`/followers/${pk}`} > <span className="followers ml-10">{user && followers}</span> followers </Link>
                    <Link to={`/followings/${pk}`} > <span className="following " > {user && followings} </span> followings </Link>
                </div>
            </div>
