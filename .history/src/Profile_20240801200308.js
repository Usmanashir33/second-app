        ...
        <div className="profile main-page ">
            ...
            <div className="user-info">
                ...
                <div className="follow">
                    <Link to={`/followin/${pk}`} > <span className="following " > {user && user.followings.length} </span> followings </Link>
                    <Link to={`/followe/${pk}`} > <span className="followers ml-10">{user && user.followers.length}</span> followers </Link>
                </div>
            </div>
