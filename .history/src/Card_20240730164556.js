...
const PostCard = ({object,doDelete,ishover,cardType}) => {
    ...
    const liked = likes.find((id) => id===currentUser.id) ? 'liked' : 'notliked'
                ...
                <div className="post-col2">
                    ...
                    <div className="postnav">
                                ...
                                <div className='post-nav-link child-link' >
                                    <div className="like" >
                                    <FontAwesomeIcon icon={faHeart} className={liked} id ={`${cardType}like-${id}`}
                                ...
                                <Link to="##" className='post-nav-link child-link' id ="view-${id}">
                                    <div className="view" >
                                    <FontAwesomeIcon icon={faEye} className="commen" />{views}
                                    </div>
                                </Link>
