...
const Profile = () => {
    ...
    const followed = user? ([...user.followers].filter((id) => id == pk) ): null ;
    console.log(user?([...user.followers].filter((id) => id == pk) ): null);
    console.log(user?user.followers:null);
    useEffect(() => {
        fetchUser(pk);
    },[followers,pk])
        ...
        <div className="profile main-page ">
            ...
            <div className="user-info">
                ...
                <div className="follow">
                    <Link to={`/followers/${pk}`} > <span className="followers ml-10">{user && user.followers.length}</span> followers </Link>
