...
const PostCard = ({object,ishover,commentClick}) => {
    const {id,body,likes,shares,reposts,views,date,comment} = object;
    const {first_name,last_name,username} = object.user? object.us;
    ...
    return ( 
        <div className="post-card" key={id} onClick={(e) => history.push(`/post/${id}/`)}>
