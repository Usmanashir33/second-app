                ...
                <form onSubmit={(e) => {handleSubmit(e)}} className="comment-form relative float-form relative" id="comment-form">
                 ...
                 <div className="form-header">
                     ...
                     {<section>
                        ...
                        dis value={username} onChange={(e) => {setUsername(e.target.value)}}  placeholder=" username" />
                    </section>}
                    <section>
                        <input type="email" name="email" id="email" 
                        dis value={email} onChange={(e) => {setEmail(e.target.value)}}  placeholder=" email (e.g parson@gmail.com)" />
                    </section>
                    
                     {<section>
                        <input type="text" name="first_name" id="first_name" 
                         value={first_name} onChange={(e) => {setFirstname(e.target.value)}}  placeholder=" username" />
                    </section>}
                     {<section>
                        <input type="text" name="last_name" id="last_name" 
                         value={last_name} onChange={(e) => {setLastname(e.target.value)}}  placeholder=" username" />
                    </section>}

                     {<section>
                        <input type="text" name="title" id="title" 
                         value={title} onChange={(e) => {setTitle(e.target.value)}}  placeholder=" username" />
                    </section>}

                     {<section>
                        <input type="text" name="address" id="address" 
                         value={address} onChange={(e) => {setAddress(e.target.value)}}  placeholder=" username" />
                    </section>}
