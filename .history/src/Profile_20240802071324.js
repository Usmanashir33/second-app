        ...
        <div className="profile main-page ">
            ...
            <div className="user-info">
                ...
                <div className="follow">
                    <Link to={`/followers/${pk}`} > <span className="followers ml-10">{usefollowers}</span> followers </Link>
                    <Link to={`/followings/${pk}`} > <span className="following " > {usefollowings} </span> followings </Link>
                </div>
            </div>
