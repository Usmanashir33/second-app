...
const PostForm = () => {
    const {succe} = useContext(authContext) ;
    // const history = useHistory();
    const {posts,setPosts} = useContext(dataRendingContext);
                ...
                <form onSubmit={(e) => {handleSubmit(e)}}>
                    ...
                    <div className="post-form-footer ">
                        ...
                        <div className="buttons">
                            { success && <button disabled type="submit" id="add-post">posting...</button>}
                            { !success && <button  type="submit" id="">Post</button>}
                        </div>
                    </div>
                </form>
            </div>
