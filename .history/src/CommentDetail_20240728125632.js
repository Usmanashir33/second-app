    ...
    return (
        <div className="post-detail-page relative">
           <header className="flex center-v profile-header">
            ...
            <div className="mt-45">
                {comment && <PostCard object = {comment} ishover ='no' commentClick={setVisible} cardType='comment' />}
            </div>
            ...
            {(replies && !replies.lengt) && <div className="no-data"> No Replies available now</div>}
