        ...
        <div className="profile main-page ">
            ...
            <div className="user-info">
                ...
                <div className="follow">
                    <Link> <span className="following " onClick={() => {history.push(`/followers/`)}}> {user && user.followings.length} </span>Followings </Link>
                    <Link> </Link> <span className="followers ml-10">{user && user.followers.length}</span> Followers
                </div>
            </div>
