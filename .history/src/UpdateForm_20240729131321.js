                 ...
                 <div className="form-header">
                     ...
                     <div className="post-card borderless post-in-form">
                         ...
                         <div className="post-col2">
                             ...
                             <div className="post-col2">
                               {body && <textarea name="comment" id="comment" autoFocus cols="30" rows="4" 
                                required value={body} onChange={(e) => {setTextArea(e.target.value)}} placeholder="Update your data"></textarea>}
                            </div>
