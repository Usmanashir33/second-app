        ...
        <div className="profile main-page ">
            ...
            <div className="user-info">
                ...
                <div className="follow">
                    <Link to={`/followers/${pk}`} > <span className="followers ml-10">{user && user.followers.lengt}</span> followers </Link>
                    <Link to={`/followings/${pk}`} > <span className="following " > {user && user.followings.lengt} </span> followings </Link>
                </div>
            </div>
