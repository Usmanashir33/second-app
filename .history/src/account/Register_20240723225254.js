        ...
        <div className="r-form">
            <form >
                ...
                <section>
                    ...
                    value={passw} onChange={(e) => {setPassword1(e.target.value)}}   placeholder=" password" />
                </section>
                { !haveaccount && <section className="password2">
                    <input type="password" name="password2" id="password2"
                    value={passw} onChange={(e) => {setPassword1(e.target.value)}}   placeholder="confirm password" />
                </section>}
