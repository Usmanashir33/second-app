        ...
        <div className="r-form">
            <form onSubmit={(e) => {handleFor}}>
                ...
                <section>
                    ...
                    value={password1} onChange={(e) => {setPassword1(e.target.value)}}   placeholder=" password" />
                </section>
                { !haveaccount && <section className="password2">
                    <input type="password" name="password2" id="password2"
                    value={password2} onChange={(e) => {setPassword1(e.target.value)}}   placeholder="confirm password" />
                </section>}
