...
const Register = () => {
    ...
    const [passwordmis,setpasswordmis]= useState()
        ...
        <div className="r-form">
            ...
            <form onSubmit={(e) => {handleForm(e)}}>
                ...
                { !haveaccount && <section className="password2">
                    ...
                    required value={password2} onChange={(e) => {setPassword2(e.target.value);checkPassword(e)}}   placeholder="confirm password" />
                </section>}
                {!haveaccount && <p className="error-password">passwords mismatched</p>}
