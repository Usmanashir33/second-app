        ...
        <div className="r-form">
            <form onSubmit={(e) => {handleForm(e)}}>
                ...
                <section>
                    ...
                    revalue={username} onChange={(e) => {setUsername(e.target.value)}}  placeholder=" username" />
                </section>
                <section>
                    <input type="password" name="password1" id="password1"
                    revalue={password1} onChange={(e) => {setPassword1(e.target.value)}}   placeholder=" password" />
                </section>
                { !haveaccount && <section className="password2">
                    <input type="password" name="password2" id="password2"
                    revalue={password2} onChange={(e) => {setPassword1(e.target.value)}}   placeholder="confirm password" />
                </section>}
