        ...
        <div className="r-form">
            <form >
                ...
                <section>
                    ...
                    value={username} onChange={(e) => {s}}  placeholder=" username" />
                </section>
                <section>
                    <input type="password" name="password1" id="password1"
                    value={username} onChange={(e) => {s}}   placeholder=" password" />
                </section>
                { !haveaccount && <section className="password2">
                    <input type="password" name="password2" id="password2"
                    value={username} onChange={(e) => {s}}   placeholder="confirm password" />
                </section>}
