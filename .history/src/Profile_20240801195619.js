        ...
        <div className="profile main-page ">
            ...
            <div className="user-info">
                ...
                <div className="follow">
                    <Link to={`/followings/`} > <span className="following " > {user && user.followings.length} </span> Followings </Link>
                    <Link to={`/followers/`} > <span className="followers ml-10">{user && user.followers.length}</span> Followers </Link>
                </div>
            </div>
