        ...
        <div className="profile main-page ">
            ...
            <div className="user-info">
                ...
                <div className="follow">
                    <Link></Link><span className="following " onClick={() => {history.push(`/followers/`)}}> {user && user.followings.length} </span>Followings 
                    <Link className="followers ml-10">{user && user.followers.length}</Link> Followers
                </div>
            </div>
